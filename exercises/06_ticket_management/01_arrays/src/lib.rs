...
impl WeekTemperatures {
    pub fn new() -> Self {
        let temperatures: [Option<i32>; 7] = [None, None, None, None, None, None, None];
        WeekTemperatures { temperatures }
    }

    pub fn get_temperature(&self, day: Weekday) -> Option<i32> {
        self.temperatures[self.get_day_index(day)]
    }

    pub fn set_temperature(&mut self, day: Weekday, temperature: i32) {
        let index = self.get_day_index(day);
        self.temperatures[index] = Some(temperature);
    }

    fn get_day_index(&self, day: Weekday) -> usize {
        match day {
            Weekday::Monday => 0,
            Weekday::Tuesday => 1,
            Weekday::Wednesday => 2,
